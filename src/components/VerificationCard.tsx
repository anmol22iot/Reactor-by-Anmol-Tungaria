    ...
    <div className="bg-[#0f1420] border border-[#1a233a] rounded-xl p-4 shadow-xl flex flex-col justify-between">
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[9px] font-mono px-2 py-0.5 rounded bg-emerald-950/80 text-emerald-400 border border-emerald-800/50 font-bold">
            NON-SELF-REPORTED
          </span>
        </div>
        ...
        <div className="space-y-1.5 text-xs font-mono">
          {/* Criterion 1 */}
          <div className="flex items-center justify-between p-1.5 rounded bg-[#141b2d]/80 border border-[#1a233a]">
            <span className="flex items-center gap-2 text-slate-200">
              <span className={`font-bold ${isVerified ? 'text-emerald-400' : 'text-slate-500'}`}>✓</span>
              500 / 500 Orders Protected
            </span>
            <span className="text-[10px] text-slate-400">External ERP Polled</span>
          </div>
          ...
          <div className="flex items-center justify-between p-1.5 rounded bg-[#141b2d]/80 border border-[#1a233a]">
            ...
            <span className="text-[10px] text-slate-400">Carrier SLA Bound</span>
          </div>
          ...
          <div className="flex items-center justify-between p-1.5 rounded bg-[#141b2d]/80 border border-[#1a233a]">
            ...
            <span className="text-[10px] text-slate-400">Fully Autonomous</span>
          </div>
        </div>
      </div>

      <div className="mt-3 pt-2 border-t border-[#1a233a] flex items-center justify-between text-[11px] font-mono">
        <span className="text-slate-400">Final Engine Verdict:</span>
        <span className={`font-bold tracking-wider ${isVerified ? 'text-emerald-400 animate-pulse' : 'text-cyan-400'}`}>
